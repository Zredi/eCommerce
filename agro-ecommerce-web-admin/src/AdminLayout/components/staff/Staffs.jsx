...
import { fetchStaffs, fetchUsers, setSelectedUser } from '../../../features/userReducer'
                ...
                <div className="overflow-x-auto">
                    <table className="w-full">
                        <thead className="bg-gray-200">
                            <tr>
                                {['SL', 'ID', 'Name', 'Email', 'Phone', 'Role', 'Actions'].map(header => (
                                ...
                                >
                                    ...
                                    <td className="p-4">
                                        <div className="flex gap-2">
                                            <Tooltip title="View">
                                                <IconButton onClick={() => handleViewUser(user)} className="hover:bg-teal-100">
                                                    <FaEye className="text-blue-600" />
                                                </IconButton>
                                            </Tooltip>
                                            <Tooltip title="Edit">
                                                <IconButton onClick={() => handleEditUser(user)} className="hover:bg-teal-100">
